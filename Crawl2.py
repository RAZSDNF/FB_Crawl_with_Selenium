...
time.sleep(5)
fb_post_url="https://www.facebook.com/groups/xxxxxx/permalink/xxxxxxx"
while True:
    try:
        time.sleep(10)
        driver.get("https://www.facebook.com/groups/xxxxxxxx")
        time.sleep(10)
        ...
        if ("dec" in ul_an1.text.lower()):
            ...
            while (True):
                ...
                sent = client.send(Message(text="Found Something"), thread_id="user_id",
                                   thread_type=ThreadType.USER)
                if sent:
                    print("Message sent successfully!")
        elif("groups/xxxxxxx/permalink/" in ul_an1.text.lower()):
            ...
            fw.close()
            f.close()
            cmd = 'python2 '+os.path.dirname(os.path.abspath(__file__))
            os.system(cmd)
